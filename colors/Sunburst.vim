...
hi StatusLine ctermfg=231 ctermbg=220 cterm=bold guifg=NONE guibg=NONE gui=bold
"hi StatusLineNC ctermfg=231 ctermbg=238 cterm=NONE guifg=#f8f8f8 guibg=#484848 gui=NONE
hi StatusLineNC ctermfg=231 ctermbg=220 cterm=NONE guifg=NONE guibg=NONE gui=NONE
